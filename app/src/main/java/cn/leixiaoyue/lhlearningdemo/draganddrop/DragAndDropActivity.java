package cn.leixiaoyue.lhlearningdemo.draganddrop;
...
/**
 * shows how to drag and drop a view
 * long click the color block to start drag,
 * get different response when be dropped in different area.
 * Created by Little_Happy on 2016/1/19.
 */
...
//        mBottomView.addFriends(mTopView);
    ...
    /**
     * adds some color block into the top view
     */
    private void produce() {
        Random random = new Random();
        final int colorBlockSideLength = 100;
        for (int i = 0; i < 10; i++) {
            View view = new View(this);
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(colorBlockSideLength,colorBlockSideLength);
